...
def process_proton(NMR_file, molecule, solvent, datatype):
    """should return undercooked protondata, will reintegrate when faced with a proposal
    Arguments:
    - NMR_file: file with 1H NMR raw data
    - molecule: rdkit Mol object, required for working out connectivity
    - solvent: name of the solvent, required for solvent peak removal
    - datatype: type of data, can be 'bruker' or 'jcamp'
    """
    ...
    peak_regions, grouped_peaks, sim_regions, integral_sum, cummulative_vectors, integrals, number_of_protons_structure, optimum_proton_number, total_integral = find_integrals(
        ...
        molecule, peak_regions, grouped_peaks, sim_regions, picked_peaks, total_params,
