...
class DFTMethod(BaseDFTMethod):
    def __init__(self, settings):
        ...
        for i in 'noe':
            self.settings[f'{i}_basis_set'] = 'def2-tzvp' if self.settings[f'{i}_basis_set'] == 'def2tzvp' else self.settings[f'{i}_basis_set']
                ...
                try:
                    ...
                    if line == 'CHEMICAL SHIELDING SUMMARY (ppm)':
                        ...
                        while line:
                            ...
                            _shieldings.append((int(num)+1, float(shielding),'%s%i' % (elem, int(num)+1)))
