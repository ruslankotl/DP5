...
class ConfSearchMethod(BaseConfSearch):
    ...
    def prepare_input(self):
        ...
        for input in self.inputs:
            if not os.path.exists(f"{input}.mae"):
                if self.executable:
                    outp = subprocess.check_output(f"{convinp}{input}.sdf -omae {input}.mae",
                                               shell=True)
                else:
            ...
            with open((Path.cwd() / f'{input}.com').resolve(), 'w') as f:
                cmd = self.command.format(input, self.ff_code, self.settings['step_count'])
                f.write(cmd)
    ...
    def read_macromodel(self, file, cutoff_energy):
        ...
        atoms_to_symbols = {'1':'C','2':'C','3':'C','4':'C','5':'C','6':'C',
                            '7':'C','8':'C','9':'C','10':'C','11':'C','12':'C',
                            '13':'C','14':'O','15':'O','16':'O','18':'O',
                            '20':'O','21':'O','23':'O','24':'N','25':'N',
                            '26':'N','31':'N','32':'N','38':'N','39':'N',
                            '40':'N','41':'H','42':'H','43':'H','44':'H',
                            '45':'H','48':'H','49':'S','51':'S','52':'S',
                            '53':'P','54':'B','55':'B','56':'F','57':'Cl',
                            '58':'Br','59':'I','60':'Si','100':'S','101':'S',
                            '102':'Cl','103':'B','104':'F','109':'S','110':'S',
                            '113':'S','114':'S'}
                ...
                try:
                    ...
                    if line.startswith(' m_atom['):
                        ...
                        while not ':::' in line:
                            ...
                            coords.append([float(i) for i in (line[xpos], line[ypos], line[zpos])])
